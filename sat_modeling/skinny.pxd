...
cdef extern from "skinny-c/include/skinny128-cipher.h":
    ...
    int skinny128_set_key(Skinny128Key_t *ks, const void *key, unsigned size) noexcept nogil
    void skinny128_ecb_encrypt(void *output, const void *input, const Skinny128Key_t *ks) noexcept nogil;
    void skinny128_ecb_decrypt(void *output, const void *input, const Skinny128Key_t *ks) noexcept nogil;



cdef int _skinny_enc_ecb(uint8_t *ct, const uint8_t *pt, const uint8_t *tweakey, unsigned int ct_len, unsigned int numrounds) noexcept nogil
